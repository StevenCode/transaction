...
public class TransactionConfig {
    ...
    /**
     * 提供不同的序列化对象 {@linkplain com.steven.transaction.common.enums.SerializeEnum}
     */
    private String serializer = "kryo";

    /**
     * 补偿存储类型{@linkplain com.steven.transaction.common.enums.RepositorySupportEnum}
     */
    ...
    public TransactionConfig(final Builder builder) {
        builder(builder);
    }
