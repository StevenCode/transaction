package com.steven.transaction.core.spi.repository;
...
import com.steven.transaction.common.config.DbConfig;
...
import com.steven.transaction.common.utils.RepositoryPathUtils;
import com.steven.transaction.core.helper.SqlHelper;
...
public class JdbcCoordinatorRepository implements CoordinatorRepository {
    ...
    @Override
    public int updateStatus(final String id, Integer status) throws TransactionRuntimeException {
    ...
    @Override
    public void init(String modelName, TransactionConfig transactionConfig) throws TransactionRuntimeException {
        dataSource = new DruidDataSource();
        final DbConfig tccDbConfig = transactionConfig.getDbConfig();
